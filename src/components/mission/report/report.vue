<template>
  <div class="layer">
    ...
    <div class="list-div">
      <div class="title">
        <div class="li">被举报用户ID</div>
        <div class="li">被举报用户名称</div>
        <div class="li">被举报用户所执行的任务名称</div>
        <div class="li">举报商家ID</div>
        <div class="li">举报商家名称</div>
        <div class="li">举报理由</div>
        <div class="li">举报时间</div>
        <div class="li">操作</div>
      </div>
      <div class="title" v-for="(item,key) in totalData" :key="key">
        ...
        <div class="li">
            <span class="li-abq1" v-show="state==0" @click="detailsTZ(item.TaskReceiveId,0)">处理</span>
            <span class="li-abq1" v-show="state==1" @click="detailsTZ(item.TaskReceiveId,1)">查看</span>
        </div>
      </div>
      <div class="pagingdiv">
        <!-- 全局分页组件 -->
